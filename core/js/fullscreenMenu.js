...
function toggleSettingsMainMenu(force = false)
{
	if(!force && !globalForcePageNavigate)
	{
		if(!(goToPageCheck("toggleSettingsMainMenu(true)")))
		{
			return false;
		}
	}
...
function toggleSettingsMainLogLayout(force = false)
{
	if(!force && !globalForcePageNavigate)
	{
		if(!(goToPageCheck("toggleSettingsMainLogLayout(true)")))
		{
			return false;
		}
	}
	...
	hideSettingsStuff();
	endSettingsPollTimer();
	document.getElementById("settingsMainLogLayout").style.display = "block";
	$("#settingsMainLogLayoutMenu").addClass("selected");
	arrayOfDataSettings = ['settingsInitialLoadLayoutVars'];
	arrayOfScrollHeaderUpdate = ['settingsInitialLoadLayoutVars'];
	onScrollShowFixedMiniBar(arrayOfScrollHeaderUpdate);
	resizeFullScreenMenu();
	startSettingsPollTimer();
}

function toggleSettingsMainOther(force = false)
{
	if(!force && !globalForcePageNavigate)
	{
		if(!(goToPageCheck("toggleSettingsMainOther(true)")))
		{
			return false;
		}
	}
	...
	hideSettingsStuff();
	endSettingsPollTimer();
	document.getElementById("settingsMainOther").style.display = "block";
	$("#settingsMainOtherMenu").addClass("selected");
	arrayOfDataSettings = ['settingsMainVars'];
	arrayOfScrollHeaderUpdate = ['settingsMainVars'];
	onScrollShowFixedMiniBar(arrayOfScrollHeaderUpdate);
	resizeFullScreenMenu();
	startSettingsPollTimer();
}
