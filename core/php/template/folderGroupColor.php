			...
			foreach ($folderColorArrays as $key => $value):
				...
				<li>
					...
					foreach ($value['main'] as $key2 => $value2):
						...
						<input style="width: 100px; display: none;" type="text" name="folderColorValueMain<?php echo $i; ?>-<?php echo $j;?>" value="<?php echo $value2; ?>" >
					<?php endforeach; 
					...
					foreach ($value['highlight'] as $key2 => $value2):
						...
						<input style="width: 100px; display: none;" type="text" name="folderColorValueHighlight<?php echo $i; ?>-<?php echo $j;?>" value="<?php echo $value2; ?>" >
					<?php endforeach; 
					...
					foreach ($value['active'] as $key2 => $value2):
						...
						<input style="width: 100px; display: none;" type="text" name="folderColorValueActive<?php echo $i; ?>-<?php echo $j;?>" value="<?php echo $value2; ?>" >
					<?php endforeach; 
					...
					foreach ($value['highlightActive'] as $key2 => $value2):
						...
						<input style="width: 100px; display: none;" type="text" name="folderColorValueActiveHighlight<?php echo $i; ?>-<?php echo $j;?>" value="<?php echo $value2; ?>" >
					<?php endforeach; 
