...
$themeDefaultSettings = array(
	...
	'backgroundHeaderColor' => "
		repeating-linear-gradient(45deg, rgba(25,40,55,0.75) 35%, rgba(65,85,100,0.75) 40%, rgba(65,85,100,0.75) 42%, rgba(25,40,55,0.75) 50%, rgba(25,40,55,0.75) 55%, rgba(70,85,100,0.75) 60%, rgba(70,85,100,0.75) 75%, rgba(25,40,55,0.75) 90%);
	...
	'scrollBarHandle'				=> 'background: rgba(255,255,255,1); border-radius: 2px;',
	'scrollBarHandleHover'			=> 'background: rgba(50,50,50,1);',
	'scrollBarTrack'				=> 'background: rgba(65,85,100,1);',
